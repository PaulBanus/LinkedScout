...
class TestJobPosting:
    ...
    def test_job_posting_frozen(self):
...
class TestSearchCriteria:
    ...
    def test_search_criteria_to_params_minimal(self):
...
class TestSavedAlert:
    ...
    def test_create_saved_alert(self):
...
"""
    ...
    def test_alert_from_yaml_backwards_compatible(self):
...
"""
    ...
    def test_alert_save_and_load(self, temp_dir):
...
class TestAlertsConfig:
    ...
    def test_create_config_with_alerts(self):
...
"""
    ...
    def test_config_from_empty_yaml(self):
    ...
    def test_add_duplicate_alert_raises_error(self):
    ...
    def test_update_alert(self):
        ...
        assert config.get_alert("alert1").enabled is True
    ...
    def test_update_nonexistent_alert_raises_error(self):
    ...
    def test_remove_nonexistent_alert_raises_error(self):
...
class TestEnumSerialization:
    ...
    def test_serialize_enum(self, enum_value, expected_string):
    ...
    def test_deserialize_time_filter(self, string_value, expected_enum):
    ...
    def test_deserialize_work_model(self, string_value, expected_enum):
    ...
    def test_deserialize_job_type(self, string_value, expected_enum):
